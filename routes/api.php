...
Route::group(["prefix" => 'booking'], function () {
    Route::get('/', 'BookingController@index')->middleware(['tokenVerification', 'adminVerification']);
    Route::get('/group/', 'BookingController@indexGroup')->middleware(['tokenVerification', 'adminVerification']);
    Route::get('/pending/', 'BookingController@indexPending')->middleware(['tokenVerification', 'adminVerification']);
    Route::get('/group/pending/', 'BookingController@indexPendingGroup')->middleware(['tokenVerification', 'adminVerification']);
    ...
    Route::get('/email/{id}', 'BookingController@sendEmail')->middleware(['tokenVerification', 'adminVerification']);
    ...
    Route::post('/admin/', 'BookingController@adminCreate')->middleware(['tokenVerification', 'adminVerification']);
    Route::post('/admin/group', 'BookingController@adminGroupCreate')->middleware(['tokenVerification', 'adminVerification']);
    ...
    Route::post('/checkin/{id}', 'BookingController@checkin')->middleware(['tokenVerification', 'adminVerification']);
});
